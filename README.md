<!-- ⚠️ This README has been generated from the file(s) "blueprint.md" ⚠️--><h1 align="center">Shapeshifter</h1>

<p align="center">
  <img src="https://raw.githubusercontent.com/Fazendaaa/Shapeshifter/master/assets/img/logo.svg" alt="Logo" width="150" height="150" />
</p>
...
<p align="center">
  <b>Speech recognition SDK to glue all other monsters projects</b></br>
  <sub><sub>
</p>
...
Welcome to Fazendaaa's Shapeshifter. This is version 0.0.0!
...
Currently, in the company that I work for we have a CLI (Command Line Interface) made in [Python](https://www.python.org/) called `estat` that you can read more about it right [here](https://github.com/Fazendaaa/Succubus). One of its future features is to add NPL trough speach recognition, making it more easily acessible and available.
...
- [Jinn](https://github.com/Fazendaaa/Jinn): universal project manager built to expand Shapeshifter capabilities
- [Baba Yaga](https://github.com/Fazendaaa/BabaYaga): universal cloud-native manager built to expand Jinn and Shapeshifter capabilities
...
- [Shapeshifter](github.com/Fazendaaa/Shapeshifter): Speech recognition SDK to glue all other monsters projects
